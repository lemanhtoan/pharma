					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Thêm mới khách hàng</span>
							</div>							
						</div>
							...
							<form action="{{ route('business.listing.create') }}" method="post" id="form_sample_2" class="form-horizontal"  enctype="multipart/form-data">
								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Tên khách hàng <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Điện thoại <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Địa chỉ <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Quận huyện <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Tỉnh thành <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Loại khách hàng <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												...
												<select name="name_value" id="" class="form-control">
													<option value="value1">Nhà thuốc lẻ</option>
													<option value="value1">Nhà thuốc sỉ</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="control-label col-md-3">Chủ nhà thuốc <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<select name="name_value" id="" class="form-control">
													<option value="value1">Nguyễn Văn A</option>
													<option value="value1">Nguyễn Văn B</option>
												</select>
											</div>
										</div>
									</div>
