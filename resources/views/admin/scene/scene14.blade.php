		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green-sharp bold uppercase">Danh sách người dùng/#213</span>
				</div>							
			</div>
				...
				<form action="#" method="post" id="form_sample_2" class="form-horizontal"  enctype="multipart/form-data">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">Tên người dùng <span class="required">
							* </span>
							</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="control-label col-md-3">SĐT <span class="required">
							* </span>
							</label>
							<div class="col-md-4">
								<div class="input-icon right">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="password" class="form-control" value="{{ old('old_value') }}" name="name"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="checkbox" name="name_value" value="{{ 'value' }}" class="icheck" data-checkbox="icheckbox_flat-grey">
								</div>
							</div>
						</div>
	...
	<div class="col-lg-12">
		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs font-green-sharp"></i>
					<span class="caption-subject font-green-sharp bold uppercase">Lịch sử hoạt động của tài khoản</span>
				</div>							
			</div>
