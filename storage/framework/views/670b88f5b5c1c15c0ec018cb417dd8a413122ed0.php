...
?>
   ...
   <form action="<?php echo url('/updateProfile'); ?>" method="POST"  class='profile-form' accept-charset="utf-8">
		...
		<div class="item-row">
			...
			<img class="icon-clear clr-password" src="<?php echo url('/images/thong_tin_user_03.png'); ?>" alt="">
		</div>
