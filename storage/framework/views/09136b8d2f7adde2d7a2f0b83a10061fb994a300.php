          ...
          <tr>
            ...
            <th>
              ...
              <a href="#" name="minds.start_time" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'minds.start_time' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Kết thúc
              <a href="#" name="minds.end_time" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'minds.end_time' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Trạng thái
  ...
  <script>
    ...
    $(function() {
      ...
      $(document).on('change', ':checkbox[name="status"]', function() {
        ...
        $.ajax({
          url: '<?php echo e(url('postActmind')); ?>' + '/' + this.value,
          type: 'PUT',
