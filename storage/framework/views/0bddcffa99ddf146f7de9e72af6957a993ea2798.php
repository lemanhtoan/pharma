		...
		<div class="box-login">
			...
			<div class="box-wrap">
				<div class="box-wrap-border">
					<?php echo Form::open(['url' => 'administrator', 'method' => 'post', 'role' => 'form']); ?>
...
<?php echo $__env->make('front.template-login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>