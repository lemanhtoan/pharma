   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="fa fa-user"></span> Xin chào, <?php echo e(auth()->user()->username); ?><b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo url('auth/logout'); ?>"><span class="fa fa-fw fa-power-off"></span> Đăng xuất</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <?php if(session('statut') == 'admin'): ?>
                        ...
                        <li>
                            <a href="<?php echo route('admin'); ?>"><span class="fa fa-fw fa-dashboard"></span> Giao dịch</a>
                        </li>
                        ...
                        <li>
                            <a href="<?php echo route('admin'); ?>"><span class="fa fa-fw fa-dashboard"></span> Khách hàng</a>
                        </li>
                        <li <?php echo classActiveSegment(1, 'user'); ?>>
                            <a href="#" data-toggle="collapse" data-target="#usermenu"><span class="fa fa-fw fa-user"></span> Người dùng <span class="fa fa-fw fa-caret-down"></span></a>
                    ...
                    <li <?php echo classActiveSegment(1, 'blog'); ?>>
                        <a href="#" data-toggle="collapse" data-target="#articlemenu"><span class="fa fa-fw fa-pencil"></span> <?php echo e(trans('back/admin.posts')); ?> <span class="fa fa-fw fa-caret-down"></span></a>
