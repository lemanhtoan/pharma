<?php $__env->startSection('main'); ?>
  ...
  <?php echo $__env->make('back.partials.entete', ['title' => 'Danh sách thuốc' . link_to_route('drug.create', 'Thêm mới', [], ['class' => 'btn btn-info pull-right']), 'icone' => 'pencil', 'fil' => 'Danh sách thuốc'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="row col-lg-12">
    <div class="search-bar pull-left" style="margin-left: -15px">
      ...
      <input required="required" value="<?php if(isset($_GET['search'])) {echo $_GET['search'];} else {echo '';}?>" class="form-control" placeholder="Tìm theo Tên thuốc, Hoạt chất, CTy Sx,..." name="search" type="text">
      <input class="btn btn-default" type="submit" value="Tìm kiếm">
      <a href="<?php echo route('drug.index'); ?>" class="btn btn-default">Hủy</a><br/>
          ...
          <tr>
            <th>
              ...
              <a href="#" name="drugs.code" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.code' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Tên thuốc
              <a href="#" name="drugs.name" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.name' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Hoạt chất chính
              <a href="#" name="drugs.activeIngredient" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.activeIngredient' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Nhóm thuốc
              <a href="#" name="drugs.group_drug_id" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.group_drug_id' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Hàm lượng
              <a href="#" name="drugs.content" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.content' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              QC đóng gói
              <a href="#" name="drugs.package" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.package' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Công ty SX
              <a href="#" name="drugs.produceCompany" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.produceCompany' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
            <th>
              Trạng thái
              <a href="#" name="drugs.status" class="order">
                <span class="fa fa-fw fa-<?php echo e($order->name == 'drugs.status' ? $order->sens : 'unsorted'); ?>"></span>
              </a>
            </th>
          </tr>
        </thead>
        <tbody>
          <?php echo $__env->make('back.drug.table', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </tbody>
      </table>
    </div>
  </div>
  ...
  <script>
    ...
    $(function() {
      ...
      $(document).on('change', ':checkbox[name="status"]', function() {
        ...
        $.ajax({
          url: '<?php echo e(url('postActdrug')); ?>' + '/' + this.value,
          type: 'PUT',
